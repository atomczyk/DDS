...
{- Instancja dla Random, bez Verum
-}
...
niladicNodes  = [Verum, V 0] -- [Verum, V 0] -- można dodawać w zalezności od potrzeb
unaryNodes    = [N Verum]
binaryNodes   = [I Verum Verum]  -- [I Verum Verum, A Verum Verum, D Verum Verum, E Verum Verum]
